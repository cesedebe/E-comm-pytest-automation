...
class TaxHelper(object):
    ...
    def get_tax_rate_by_id(self, tax_id, expected_status_code=200):
        return self.woo_utility.get(f"taxes/{tax_id}", expected_status_code=expected_status_code)
    ...
    def delete_tax_rate(self, tax_id, payload=None, expected_status_code=200):
